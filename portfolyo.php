...
<section class="banner-news header-three-margin"></section>
			...
			<div id="content">
                   <?php 
 $haberSorgu = mysql_query("SELECT * FROM projeler WHERE durum = 1 ORDER BY id DESC");
...
$gresimler=mysql_query( "SELECT * FROM proje_resim WHERE resim_id = '$projid'");
while($resimlerr=mysql_fetch_array($gresimler)){
?>
									<li>
