...
{
	$id = g('id');
	$resim_bul=Sonuc(Sorgu("SELECT * FROM proje_kategori WHERE id='$id'"));
	$resim_sil=unlink("../uploads/projekategori/".$resim_bul->resim);
	$resim_sil2=unlink("../uploads/projekategori/thumb/".$resim_bul->resim);
	
	$kategori_sil_sorgu = Sorgu("DELETE FROM proje_kategori WHERE id='$id'");
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-tasks"></i> Kategori Listesi</small>
          </h1>
          <ol class="breadcrumb">
              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
        <?php $KategoriSorgu = Sorgu("SELECT * FROM proje_kategori ORDER BY id DESC");
        while($KategoriSonuc = Sonuc($KategoriSorgu)){?>
			 ...
			 <a href="?sayfa=proje-kategori-ekle&islem=duzenle&id=<?php echo $KategoriSonuc->id;?>" class="btn btn-info btn-xs" title="Düzenle" id="add-sticky">
			 Düzenle
			 </a>
                        </td>
                      </tr>
