...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-picture-o"></i> Ürün Listesi</small>
          </h1>
          <ol class="breadcrumb">
        ...
        <?php $kat = Sonuc(Sorgu("SELECT * FROM urun_kategori WHERE id = '{$UrunSonuc->kategori}'"));?>
                      <tr>
			 ...
			 <a href="?sayfa=urun-ekle&islem=duzenle&id=<?php echo $UrunSonuc->id;?>" class="btn btn-info btn-xs" title="Düzenle" id="add-sticky">
			 Düzenle
			 </a>
                        </td>
                      </tr>
