...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-bullhorn"></i> Haber Listesi</small>
          </h1>
          <ol class="breadcrumb">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <a href="haber-ekle.html" class="btn bg-navy margin"><i class="fa fa-plus"></i> Haber Ekle</a>
                </div><!-- /.box-header -->
                <div class="box-body">
        ...
        while($HaberSonuc = Sonuc($HaberSorgu)){?>
			 ...
			 <a href="?sayfa=haber-ekle&islem=duzenle&id=<?php echo $HaberSonuc->id;?>" class="btn btn-info btn-xs" title="Düzenle" id="add-sticky">
			 Düzenle
			 </a>
                        </td>
                      </tr>
