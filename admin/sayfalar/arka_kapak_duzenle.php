...
if(p('durum') && g('islem')=="duzenle")
{
	...
	$upload->process("../katalog/pages/kapak/large");
	...
	$upload->image_x = 424;
	$upload->image_y = 600;
	$upload->process("../katalog/pages/kapak/medium");
	...
	if($MarkaResim!="")
	{
		...
		$resim_sil=unlink("../katalog/pages/kapak/large/".$resim_bul->resim);
		$resim_sil=unlink("../katalog/pages/kapak/medium/".$resim_bul->resim);
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-bookmark"></i> Arka Kapak Düzenle</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="anasayfa.html"><i class="fa fa-home"></i> Anasayfa</a></li>
            <li class="active">Arka Kapak Düzenle</li>
          </ol>
        </section>
        <!-- Main content -->
        <section class="content">
          <div class="row">
			...
			<div class="form-group ">
                                    <label>Arka Kapak Resmi</label>
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                   <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                    <?php if($_GET['islem']=='duzenle'){?>
                                    <img src="../katalog/pages/kapak/medium/<?php echo $MarkaSonuc->resim;?>" style="width: 200px; height: 200px;" alt="" />
                                    <?php } else { ?>
