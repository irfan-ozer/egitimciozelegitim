...
if(isset($_POST['tsil'])){
	...
	$delete = Sorgu("DELETE FROM ebulten WHERE id IN($id)");
	if($delete){
		  header("Location:ebulten.html");
		}else{
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Ebulten Listesi</li>
          </ol>
        </section>
            ...
            <?php echo $bilgi;?>
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Ebülten Listesi</h3>
                ...
                <div class="box-body no-padding">
                  <div class="mailbox-controls">
                    ...
                    <a class="btn btn-default btn-sm" href="ebulten.html"><i class="fa fa-refresh"></i></a>
                  </div>
                  <div class="table-responsive mailbox-messages">
                  <form action="" method="post" id="form1">
                    <table class="table table-hover table-striped">
                      <tbody>
                      <?php $MesajSorgu = Sorgu("SELECT * FROM ebulten");
					  if(!mysql_affected_rows()){?>
						<tr>
                            <td colspan="5">
                                 Kayıtlı Email Bulunamadı.
                            </td>
                        </tr>  
					<?php }else{
					  while($MesajSonuc = Sonuc($MesajSorgu)){?>
                        <tr>
                          ...
                          <td class="mailbox-name"><a href="#"><?php echo $MesajSonuc->email; ?></a></td>
