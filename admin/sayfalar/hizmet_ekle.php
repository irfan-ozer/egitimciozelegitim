...
if(p('haber_adi') && g('islem')=="")
{
	...
	$upload->process("../uploads/hizmetler");
	
	$upload->file_auto_rename = true;
	$upload->image_resize = true;
	$upload->image_x = 850;
	$upload->image_y = 342;
	$upload->process("../uploads/hizmetler/orta");
	
	$upload->file_auto_rename = true;
	$upload->image_resize = true;
	$upload->image_x = 180;
	$upload->image_y = 101;
	$upload->process("../uploads/hizmetler/kucuk");
	...
	$haber_sorgu	=	Sorgu("INSERT INTO hizmetler SET
										adi		=	'$haber_adi', 
										ingadi		=	'$ingadi', 
...
if($_GET['islem']=="duzenle")
{
	...
	$HaberSonuc = Sonuc(Sorgu("SELECT * FROM hizmetler WHERE id='$sayfaid'"));
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-bullhorn"></i> Hizmet Ekle</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Anasayfa</a></li>
            <li class="active">Hizmet Ekle</li>
          </ol>
        </section>
        <!-- Main content -->
                ...
                <form method="post" action="" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="haber_adi">Hizmet Adı</label>
                      <input type="text" class="form-control" name="haber_adi" value="<?php echo $HaberSonuc->adi;?>" id="haber_adi" placeholder="Hizmet Adı">
                    </div>
                    ...
                    <div class="form-group ">
                                   ...
                                   <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                    ...
                                    <img src="../uploads/hizmetler/<?php echo $HaberSonuc->resim;?>" style="width: 200px; height: 200px;" alt="" />
                                    <?php } else { ?>
