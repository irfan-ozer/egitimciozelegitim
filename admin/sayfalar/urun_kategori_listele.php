...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-tasks"></i> Referans Listesi</small>
          </h1>
          <ol class="breadcrumb">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <a href="urun-kategori-ekle.html" class="btn bg-navy margin"><i class="fa fa-plus"></i> Referans Ekle</a>
                </div><!-- /.box-header -->
                <div class="box-body">
        ...
        while($KategoriSonuc = Sonuc($KategoriSorgu)){?>
                      <tr>
						...
						<?php if($KategoriSonuc->resim == ""){?>
			 			...
			 			<?php }else{?>
			 			<a class="btn btn-success btn-xs" href="../uploads/urunkategori/large/<?php echo $KategoriSonuc->resim; ?>" target="_blank"><i class="fa fa-eye"></i> Resmi Gör</a>
						 <?php } ?>
                         </td>
                        <td>
						<?php
			 ...
			 <a href="?sayfa=urun-kategori-ekle&islem=duzenle&id=<?php echo $KategoriSonuc->id;?>" class="btn btn-info btn-xs" title="Düzenle" id="add-sticky">
			 Düzenle
			 </a>
                        </td>
                      </tr>
