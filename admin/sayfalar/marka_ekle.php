...
<?php
if(p('adi') && g('islem')==""  && $_POST['sirasi']!=NULL)
{
	$adi 		= $_POST['adi'];
	$sirasi 	= $_POST['sirasi'];
	$ingadi 	= $_POST['ingadi'];
	...
	$sayfa_sorgu	=	mysql_query("INSERT INTO markalar SET
										adi		=	'$adi', 
										ingadi	=	'$ingadi', 
										resim	=	'$sayfaresim',
										seo		=	'$seo',
...
if(p('adi') && g('islem')=="duzenle" && $_POST['sirasi']!=NULL)
{
	$adi 		= $_POST['adi'];
	$sirasi 		= $_POST['sirasi'];
	$ingadi 	= $_POST['ingadi'];
	...
	if($sayfaresim!="")
	{
		$resim_bul=mysql_fetch_object(mysql_query("SELECT * FROM markalar WHERE id='$d_id'"));
			...
			<?php echo $key;?>
              ...
              <div class="col-md-12">
               ...
               <div class="form-group">
					 ...
					 <div class="form-group">
                      <label for="adi">Gösterim Sırası</label>
                      <input type="text" class="form-control" name="sirasi" value="<?php echo $SayfaSonuc->sirasi;?>" id="adi" placeholder="" required="required">
                    </div>
				     <div class="form-group">
