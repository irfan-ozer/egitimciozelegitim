...
if(p('haber_adi') && g('islem')=="")
{
	...
	$upload->process("../uploads/duyurular");
	
	$upload->file_auto_rename = true;
	$upload->image_resize = true;
	$upload->image_x = 350;
	$upload->image_y = 250;
	$upload->process("../uploads/duyurular/orta");
	
	$upload->file_auto_rename = true;
	$upload->image_resize = true;
	$upload->image_x = 180;
	$upload->image_y = 101;
	$upload->process("../uploads/duyurular/kucuk");
	...
	$haber_sorgu	=	Sorgu("INSERT INTO duyurular SET
										adi		=	'$haber_adi', 
										ingadi		=	'$ingadi', 
...
if(p('haber_adi') && g('islem')=="duzenle")
{
	...
	if($haberResim!="")
	{
		$resim_bul	=Sonuc(Sorgu("SELECT * FROM duyurular WHERE id='$d_id'"));
		$resim_sil	=unlink("../uploads/duyurular/".$resim_bul->resim);
		$resim_sil2	=unlink("../uploads/duyurular/kucuk/".$resim_bul->resim);
	
		$haber_duzenle_sorgu	=	Sorgu("UPDATE duyurular SET 
											resim	=	'$haberResim',
											ingadi		=	'$ingadi', 
										ingaciklama	=	'$ingaciklama', 
											durum	=	'$durum', 
...
if($_GET['islem']=="duzenle")
{
	...
	$HaberSonuc = Sonuc(Sorgu("SELECT * FROM duyurular WHERE id='$sayfaid'"));
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-bullhorn"></i> Yorum Ekle</small>
          </h1>
          <ol class="breadcrumb">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
                      <label for="haber_adi">Müşteri Adı Soyadı</label>
                      <input type="text" class="form-control" name="haber_adi" value="<?php echo $HaberSonuc->adi;?>" id="haber_adi" placeholder="">
                    </div>
					
					 <div class="form-group">
                      <label for="ingadi">Müşteri Firma Adı</label>
                      <input type="text" class="form-control" name="ingadi" value="<?php echo $HaberSonuc->ingadi;?>" id="ingadi" placeholder="">
                    </div>
                    ...
                    <div class="form-group ">
                                   ...
                                   <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                    ...
                                    <img src="../uploads/duyurular/<?php echo $HaberSonuc->resim;?>" style="width: 200px; height: 200px;" alt="" />
                                    <?php } else { ?>
                  ...
                  <?php } ?>
                  <div class="form-group">
                    <label for="icerik">Müşteri Yorumu</label>
