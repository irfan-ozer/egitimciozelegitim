...
{
	$id = g('id');
	$resim_bul=Sonuc(Sorgu("SELECT * FROM projeler WHERE id='$id'"));
	...
	$urun_sil_sorgu = Sorgu("DELETE FROM projeler WHERE id='$id'");
...
<div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            <small><i class="fa fa-picture-o"></i> Proje Listesi</small>
          </h1>
          <ol class="breadcrumb">
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                ...
                <a href="proje-ekle.html" class="btn bg-navy margin"><i class="fa fa-plus"></i> Proje Ekle</a>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
        <?php $UrunSorgu = Sorgu("SELECT * FROM projeler ORDER BY id DESC");
        while($UrunSonuc = Sonuc($UrunSorgu)){?>
        <?php $kat = Sonuc(Sorgu("SELECT * FROM proje_kategori WHERE id = '{$UrunSonuc->kategori}'"));?>
                      <tr>
						...
						<?php if($UrunSonuc->resim == ""){?>
			 			...
			 			<?php }else{?>
			 			<a class="btn btn-success btn-xs" href="../uploads/projeler/<?php echo $UrunSonuc->resim; ?>" target="_blank"><i class="fa fa-eye"></i> Resmi Gör</a>
						 <?php } ?>
                         </td>
                        <td>
						<?php
			 ...
			 <a href="?sayfa=proje-ekle&islem=duzenle&id=<?php echo $UrunSonuc->id;?>" class="btn btn-info btn-xs" title="Düzenle" id="add-sticky">
			 Düzenle
			 </a>
                        </td>
                      </tr>
