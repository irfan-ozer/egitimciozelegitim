...
if(p('kategori_adi') && g('islem')=="")
{
	...
	$upload->process("../uploads/galerikategori/large");
	
	$upload->file_auto_rename = true;
	$upload->image_resize = true;
	$upload->image_x = 300;
	$upload->image_y = 132;
	$upload->process("../uploads/galerikategori/thumb");
	if ($upload->processed){
	...
	$kategori_sorgu	=	mysql_query("INSERT INTO galeri_kategori SET
...
if(p('kategori_adi') && g('islem')=="duzenle")
{
	...
	if($KategoriResim!="")
	{
		$resim_bul=mysql_fetch_object(mysql_query("SELECT * FROM galeri_kategori WHERE id='$d_id'"));
		...
		$kategori_duzenle_sorgu = Sorgu("UPDATE galeri_kategori SET 
											kategori_adi	=	'$kategori_adi',
											kategori_ingadi	=	'$kategori_ingadi',
											resim			=	'$KategoriResim', 
											seo				=	'$seo', 
...
if($_GET['islem']=="duzenle")
{
	...
	$KategoriSonuc = Sonuc(Sorgu("SELECT * FROM galeri_kategori WHERE id='$sayfaid'"));
                ...
                <form method="post" action="" enctype="multipart/form-data">
                  <div class="box-body">
                    <div class="form-group">
					 ...
					 <div class="form-group">
                      <label for="kategori_ingadi">İngilizce Kategori Adı</label>
                      <input type="text" class="form-control" name="kategori_ingadi" value="<?php echo $KategoriSonuc->kategori_ingadi;?>" id="kategori_ingadi" placeholder="Kategori İngilizce Adı">
                    </div>
                     ...
                     <div class="form-group ">
                                   ...
                                   <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                    ...
                                    <img src="../uploads/galerikategori/large/<?php echo $KategoriSonuc->resim;?>" alt="" />
                                     <?php } else { ?>
