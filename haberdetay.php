								...
								<div class="row">
									...
									<div class="blog-side-main">
										...
										<div class="blog-sidebar-img-wrapper-1">
											<img src="uploads/haberler/kucuk/<?php echo $sayfa->resim;?>" title=" " alt="" />
											<p>
 ...
 ?>   
								...
								<div class="sidebar-category tags">
									...
									<ul class="tag-list clearfix">
									                ...
									                <?php 
 $haberSorgu = mysql_query("SELECT * FROM haberler WHERE durum = 1 limit 4");
 while($haberSonuc = mysql_fetch_object($haberSorgu)){
 ?>   
										...
										<li>
										 ...
										 <?php }?>
												                <?php 
 $haberSorgu = mysql_query("SELECT * FROM projeler WHERE durum = 1 limit 4");
 while($haberSonuc = mysql_fetch_object($haberSorgu)){
 ?>   
										...
										<li>
										 ...
										 <?php }?>
												                ...
												                <?php 
 $haberSorgu = mysql_query("SELECT * FROM hizmetler WHERE durum = 1 limit 4");
 while($haberSonuc = mysql_fetch_object($haberSorgu)){
 ?>   
